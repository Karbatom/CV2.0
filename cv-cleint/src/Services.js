    ...
    <div>
      <div className='service-container'>
        <div className='service' id='service-01'>
          <div className='service-image'><img src={Mushroom01} alt='mushroom' loading="lazy" ></img></div>
        ...
        <div className='service' id='service-02'>
          <div className='service-image service-image-02'><img src={Mushroom03} alt='mushroom' loading="lazy" ></img></div>
        ...
        <div className='service' id='service-03'>
          <div className='service-image'><img src={Mushroom02} alt='mushroom' loading="lazy" ></img></div>
